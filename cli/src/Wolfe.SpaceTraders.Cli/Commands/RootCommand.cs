...
using Wolfe.SpaceTraders.Cli.Commands.Dock;
using Wolfe.SpaceTraders.Cli.Commands.Extract;
using Wolfe.SpaceTraders.Cli.Commands.Login;
using Wolfe.SpaceTraders.Cli.Commands.Logout;
using Wolfe.SpaceTraders.Cli.Commands.Markets;
using Wolfe.SpaceTraders.Cli.Commands.Me;
using Wolfe.SpaceTraders.Cli.Commands.Navigate;
using Wolfe.SpaceTraders.Cli.Commands.Orbit;
using Wolfe.SpaceTraders.Cli.Commands.Purchase;
using Wolfe.SpaceTraders.Cli.Commands.Refuel;
using Wolfe.SpaceTraders.Cli.Commands.Register;
using Wolfe.SpaceTraders.Cli.Commands.Sell;
...
using Wolfe.SpaceTraders.Cli.Commands.Token;
...
internal static class RootCommand
{
    public static Command CreateCommand(IServiceProvider services)
    {
        ...
        {
            Name = "space",
            Description = "Provides command-line access to the Space Traders API."
        };
        command.AddCommand(ClearCommand.CreateCommand(services));
        command.AddCommand(DockCommand.CreateCommand(services));
        command.AddCommand(ExtractCommand.CreateCommand(services));
        ...
        command.AddCommand(MarketsCommand.CreateCommand(services));
        command.AddCommand(NavigateCommand.CreateCommand(services));
        command.AddCommand(OrbitCommand.CreateCommand(services));
        command.AddCommand(PurchaseCommand.CreateCommand(services));
        command.AddCommand(RefuelCommand.CreateCommand(services));
        command.AddCommand(RegisterCommand.CreateCommand(services));
        command.AddCommand(SellCommand.CreateCommand(services));
        ...
        command.AddCommand(TokenCommand.CreateCommand(services));
